    ...
    public partial class CashMovementDashboardViewModel : ObservableObject
    {
        ...
        private void Export()
        {
            ...
            try
            {
                ...
                MessageBox.Show(
                    "Cash movement CSV exported successfully.",
                    "CSV Export",
                    MessageBoxButton.OK,
            ...
            catch (Exception ex)
            {
                LocalLogService.WriteException(
                    "BackOffice",
                    "Export Cash Movement CSV",
                    ex);

                MessageBox.Show(
                    "The cash movement report could not be exported. " +
        ...
        private async Task LoadDataAsync()
        {
            ...
            catch (Exception ex)
            {
                LocalLogService.WriteException(
                    "BackOffice",
                    "Load Cash Movement Dashboard",
                    ex);

                MessageBox.Show(
                    "Cash movements could not be loaded. BackOffice will remain open. " +
