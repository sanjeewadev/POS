...
namespace POS.Core.Migrations
{
    ...
    [Migration("20260613181522_PoEnterpriseFixes")]
    partial class PoEnterpriseFixes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Core.Models.DocumentSequence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaddingLength = 5,
                            Prefix = "GRN-",
                            UpdatedAt = new DateTime(2026, 6, 13, 23, 45, 22, 56, DateTimeKind.Local).AddTicks(7447)
                        });
                });
