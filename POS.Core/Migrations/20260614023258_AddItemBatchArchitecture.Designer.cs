...
namespace POS.Core.Migrations
{
    ...
    [Migration("20260614023258_AddItemBatchArchitecture")]
    partial class AddItemBatchArchitecture
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Core.Models.DocumentSequence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaddingLength = 5,
                            Prefix = "GRN-",
                            UpdatedAt = new DateTime(2026, 6, 14, 8, 2, 58, 159, DateTimeKind.Local).AddTicks(1928)
                        });
                });
