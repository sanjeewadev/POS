...
namespace POS.Core.Migrations
{
    ...
    [Migration("20260613172613_EnterpriseLedgers")]
    partial class EnterpriseLedgers
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Core.Models.DocumentSequence", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PaddingLength = 5,
                            Prefix = "GRN-",
                            UpdatedAt = new DateTime(2026, 6, 13, 22, 56, 13, 570, DateTimeKind.Local).AddTicks(1008)
                        });
                });
