    ...
    internal static partial class Program
    {
        ...
        private static int Main()
        {
            var tests = new (string Name, Action Run)[]
            {
                ...
                ("Batch pricing suggestion uses markup and rounding", BatchPricingSuggestionUsesMarkupAndRounding),
                ("Batch pricing suggestion uses target margin", BatchPricingSuggestionUsesTargetMargin),
                ("Wholesale suggestion uses Retail discount", WholesaleSuggestionUsesRetailDiscount),
                ("Pricing profit and margin preview is exact", PricingProfitAndMarginPreviewIsExact),
