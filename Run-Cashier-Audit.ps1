...
$allowedChangedFiles = @(
    ...
    "POS.Cashier.AuditTests/BackOfficeNavigationSelectionSourcePolicyAuditTests.cs",
    ...
    "POS.BackOffice.UI/ViewModels/PurchasingVariantEntryDialogViewModel.cs",
    "POS.BackOffice.UI/Views/Dialogs/PurchasingVariantEntryDialog.xaml",
    "POS.BackOffice.UI/Views/Dialogs/PurchasingVariantEntryDialog.xaml.cs",
    "POS.BackOffice.UI/Views/Dialogs/GrnBulkSellingPriceDialog.xaml",
    "POS.BackOffice.UI/Views/Dialogs/GrnBulkSellingPriceDialog.xaml.cs",
    ...
    "POS.BackOffice.UI/Views/Pages/Reports/FloatCashLogView.xaml",
    ...
    "POS.BackOffice.UI/Views/Pages/InventoryOperations/BarcodeManagementView.xaml",
